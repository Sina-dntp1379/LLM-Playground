...
- This repository is primarily for learning, experimentation, and curiosity-driven development.
- Code quality, structure, and documentation may vary between projects as ideas are explored and tested.
- Some projects may be incomplete, abandoned, or quickly prototyped.
- This README was written by an LLM.

## Why?

- AI is moving incredibly fast.
- New models, tools, and capabilities emerge almost every week.
- Keeping up can feel overwhelming.
- This repository is my way of learning, experimenting, and understanding what these technologies can do.
